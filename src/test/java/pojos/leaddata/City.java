...
public class City {
    ...
    public City withIsRequired(Boolean isRequired) {
        this.isRequired = isRequired;
        return this;
    }
    ...
    public City withEditableForUpdate(Boolean editableForUpdate) {
        this.editableForUpdate = editableForUpdate;
        return this;
    }
    ...
    public City withEditableForNew(Boolean editableForNew) {
        this.editableForNew = editableForNew;
        return this;
    }
    ...
    public City withValue(String value) {
        this.value = value;
        return this;
    }
