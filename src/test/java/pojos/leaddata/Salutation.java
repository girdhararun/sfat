...
public class Salutation {
    ...
    public Salutation withIsRequired(Boolean isRequired) {
        this.isRequired = isRequired;
        return this;
    }
    ...
    public Salutation withEditableForUpdate(Boolean editableForUpdate) {
        this.editableForUpdate = editableForUpdate;
        return this;
    }
    ...
    public Salutation withEditableForNew(Boolean editableForNew) {
        this.editableForNew = editableForNew;
        return this;
    }
    ...
    public Salutation withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Salutation withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public Salutation withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
