...
public class Primary {
    ...
    public Primary withIsRequired(Boolean isRequired) {
        this.isRequired = isRequired;
        return this;
    }
    ...
    public Primary withEditableForUpdate(Boolean editableForUpdate) {
        this.editableForUpdate = editableForUpdate;
        return this;
    }
    ...
    public Primary withEditableForNew(Boolean editableForNew) {
        this.editableForNew = editableForNew;
        return this;
    }
    ...
    public Primary withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Primary withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public Primary withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
