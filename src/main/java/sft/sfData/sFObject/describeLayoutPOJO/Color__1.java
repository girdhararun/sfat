...
public class Color__1 {
    ...
    public Color__1 withColor(String color) {
        this.color = color;
        return this;
    }
    ...
    public Color__1 withContext(String context) {
        this.context = context;
        return this;
    }
    ...
    public Color__1 withTheme(String theme) {
        this.theme = theme;
        return this;
    }
    ...
    public Color__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Color__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("color");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Color__1) == false) {
            return false;
        }
        Color__1 rhs = ((Color__1) other);
