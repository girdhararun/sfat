...
public class EditLayoutSection {
    ...
    private List<LayoutRow__1> layoutRows = new ArrayList<LayoutRow__1>();
    ...
    public EditLayoutSection withCollapsed(Boolean collapsed) {
        this.collapsed = collapsed;
        return this;
    }
    ...
    public EditLayoutSection withColumns(Integer columns) {
        this.columns = columns;
        return this;
    }
    ...
    public EditLayoutSection withHeading(String heading) {
        this.heading = heading;
        return this;
    }

    @JsonProperty("layoutRows")
    public List<LayoutRow__1> getLayoutRows() {
        return layoutRows;
    }

    @JsonProperty("layoutRows")
    public void setLayoutRows(List<LayoutRow__1> layoutRows) {
        this.layoutRows = layoutRows;
    }

    public EditLayoutSection withLayoutRows(List<LayoutRow__1> layoutRows) {
        this.layoutRows = layoutRows;
        return this;
    }
    ...
    public EditLayoutSection withLayoutSectionId(String layoutSectionId) {
        this.layoutSectionId = layoutSectionId;
        return this;
    }
    ...
    public EditLayoutSection withParentLayoutId(String parentLayoutId) {
        this.parentLayoutId = parentLayoutId;
        return this;
    }
    ...
    public EditLayoutSection withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public EditLayoutSection withTabOrder(String tabOrder) {
        this.tabOrder = tabOrder;
        return this;
    }
    ...
    public EditLayoutSection withUseCollapsibleSection(Boolean useCollapsibleSection) {
        this.useCollapsibleSection = useCollapsibleSection;
        return this;
    }
    ...
    public EditLayoutSection withUseHeading(Boolean useHeading) {
        this.useHeading = useHeading;
        return this;
    }
    ...
    public EditLayoutSection withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(EditLayoutSection.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("collapsed");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EditLayoutSection) == false) {
            return false;
        }
        EditLayoutSection rhs = ((EditLayoutSection) other);
