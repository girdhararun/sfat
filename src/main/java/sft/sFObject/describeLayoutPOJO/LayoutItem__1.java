...
public class LayoutItem__1 {
    ...
    private List<LayoutComponent__1> layoutComponents = new ArrayList<LayoutComponent__1>();
    ...
    public LayoutItem__1 withEditableForNew(Boolean editableForNew) {
        this.editableForNew = editableForNew;
        return this;
    }
    ...
    public LayoutItem__1 withEditableForUpdate(Boolean editableForUpdate) {
        this.editableForUpdate = editableForUpdate;
        return this;
    }
    ...
    public LayoutItem__1 withLabel(String label) {
        this.label = label;
        return this;
    }

    @JsonProperty("layoutComponents")
    public List<LayoutComponent__1> getLayoutComponents() {
        return layoutComponents;
    }

    @JsonProperty("layoutComponents")
    public void setLayoutComponents(List<LayoutComponent__1> layoutComponents) {
        this.layoutComponents = layoutComponents;
    }

    public LayoutItem__1 withLayoutComponents(List<LayoutComponent__1> layoutComponents) {
        this.layoutComponents = layoutComponents;
        return this;
    }
    ...
    public LayoutItem__1 withPlaceholder(Boolean placeholder) {
        this.placeholder = placeholder;
        return this;
    }
    ...
    public LayoutItem__1 withRequired(Boolean required) {
        this.required = required;
        return this;
    }
    ...
    public LayoutItem__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LayoutItem__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LayoutItem__1) == false) {
            return false;
        }
        LayoutItem__1 rhs = ((LayoutItem__1) other);
