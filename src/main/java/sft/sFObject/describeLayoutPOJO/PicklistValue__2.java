...
public class PicklistValue__2 {
    ...
    public PicklistValue__2 withActive(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public PicklistValue__2 withDefaultValue(Boolean defaultValue) {
        this.defaultValue = defaultValue;
        return this;
    }
    ...
    public PicklistValue__2 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public PicklistValue__2 withValidFor(Object validFor) {
        this.validFor = validFor;
        return this;
    }
    ...
    public PicklistValue__2 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public PicklistValue__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PicklistValue__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("active");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PicklistValue__2) == false) {
            return false;
        }
        PicklistValue__2 rhs = ((PicklistValue__2) other);
