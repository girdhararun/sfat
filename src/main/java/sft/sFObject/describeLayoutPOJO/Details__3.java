...
public class Details__3 {
    ...
    private List<PicklistValue__3> picklistValues = new ArrayList<PicklistValue__3>();
    ...
    private List<Object> referenceTo = new ArrayList<Object>();
    ...
    public Details__3 withAggregatable(Boolean aggregatable) {
        this.aggregatable = aggregatable;
        return this;
    }
    ...
    public Details__3 withAiPredictionField(Boolean aiPredictionField) {
        this.aiPredictionField = aiPredictionField;
        return this;
    }
    ...
    public Details__3 withAutoNumber(Boolean autoNumber) {
        this.autoNumber = autoNumber;
        return this;
    }
    ...
    public Details__3 withByteLength(Integer byteLength) {
        this.byteLength = byteLength;
        return this;
    }
    ...
    public Details__3 withCalculated(Boolean calculated) {
        this.calculated = calculated;
        return this;
    }
    ...
    public Details__3 withCalculatedFormula(Object calculatedFormula) {
        this.calculatedFormula = calculatedFormula;
        return this;
    }
    ...
    public Details__3 withCascadeDelete(Boolean cascadeDelete) {
        this.cascadeDelete = cascadeDelete;
        return this;
    }
    ...
    public Details__3 withCaseSensitive(Boolean caseSensitive) {
        this.caseSensitive = caseSensitive;
        return this;
    }
    ...
    public Details__3 withCompoundFieldName(String compoundFieldName) {
        this.compoundFieldName = compoundFieldName;
        return this;
    }
    ...
    public Details__3 withControllerName(Object controllerName) {
        this.controllerName = controllerName;
        return this;
    }
    ...
    public Details__3 withCreateable(Boolean createable) {
        this.createable = createable;
        return this;
    }
    ...
    public Details__3 withCustom(Boolean custom) {
        this.custom = custom;
        return this;
    }
    ...
    public Details__3 withDefaultValue(Object defaultValue) {
        this.defaultValue = defaultValue;
        return this;
    }
    ...
    public Details__3 withDefaultValueFormula(Object defaultValueFormula) {
        this.defaultValueFormula = defaultValueFormula;
        return this;
    }
    ...
    public Details__3 withDefaultedOnCreate(Boolean defaultedOnCreate) {
        this.defaultedOnCreate = defaultedOnCreate;
        return this;
    }
    ...
    public Details__3 withDependentPicklist(Boolean dependentPicklist) {
        this.dependentPicklist = dependentPicklist;
        return this;
    }
    ...
    public Details__3 withDeprecatedAndHidden(Boolean deprecatedAndHidden) {
        this.deprecatedAndHidden = deprecatedAndHidden;
        return this;
    }
    ...
    public Details__3 withDigits(Integer digits) {
        this.digits = digits;
        return this;
    }
    ...
    public Details__3 withDisplayLocationInDecimal(Boolean displayLocationInDecimal) {
        this.displayLocationInDecimal = displayLocationInDecimal;
        return this;
    }
    ...
    public Details__3 withEncrypted(Boolean encrypted) {
        this.encrypted = encrypted;
        return this;
    }
    ...
    public Details__3 withExternalId(Boolean externalId) {
        this.externalId = externalId;
        return this;
    }
    ...
    public Details__3 withExtraTypeInfo(Object extraTypeInfo) {
        this.extraTypeInfo = extraTypeInfo;
        return this;
    }
    ...
    public Details__3 withFilterable(Boolean filterable) {
        this.filterable = filterable;
        return this;
    }
    ...
    public Details__3 withFilteredLookupInfo(Object filteredLookupInfo) {
        this.filteredLookupInfo = filteredLookupInfo;
        return this;
    }
    ...
    public Details__3 withFormulaTreatNullNumberAsZero(Boolean formulaTreatNullNumberAsZero) {
        this.formulaTreatNullNumberAsZero = formulaTreatNullNumberAsZero;
        return this;
    }
    ...
    public Details__3 withGroupable(Boolean groupable) {
        this.groupable = groupable;
        return this;
    }
    ...
    public Details__3 withHighScaleNumber(Boolean highScaleNumber) {
        this.highScaleNumber = highScaleNumber;
        return this;
    }
    ...
    public Details__3 withHtmlFormatted(Boolean htmlFormatted) {
        this.htmlFormatted = htmlFormatted;
        return this;
    }
    ...
    public Details__3 withIdLookup(Boolean idLookup) {
        this.idLookup = idLookup;
        return this;
    }
    ...
    public Details__3 withInlineHelpText(Object inlineHelpText) {
        this.inlineHelpText = inlineHelpText;
        return this;
    }
    ...
    public Details__3 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Details__3 withLength(Integer length) {
        this.length = length;
        return this;
    }
    ...
    public Details__3 withMask(Object mask) {
        this.mask = mask;
        return this;
    }
    ...
    public Details__3 withMaskType(Object maskType) {
        this.maskType = maskType;
        return this;
    }
    ...
    public Details__3 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Details__3 withNameField(Boolean nameField) {
        this.nameField = nameField;
        return this;
    }
    ...
    public Details__3 withNamePointing(Boolean namePointing) {
        this.namePointing = namePointing;
        return this;
    }
    ...
    public Details__3 withNillable(Boolean nillable) {
        this.nillable = nillable;
        return this;
    }
    ...
    public Details__3 withPermissionable(Boolean permissionable) {
        this.permissionable = permissionable;
        return this;
    }

    @JsonProperty("picklistValues")
    public List<PicklistValue__3> getPicklistValues() {
        return picklistValues;
    }

    @JsonProperty("picklistValues")
    public void setPicklistValues(List<PicklistValue__3> picklistValues) {
        this.picklistValues = picklistValues;
    }

    public Details__3 withPicklistValues(List<PicklistValue__3> picklistValues) {
        this.picklistValues = picklistValues;
        return this;
    }
    ...
    public Details__3 withPolymorphicForeignKey(Boolean polymorphicForeignKey) {
        this.polymorphicForeignKey = polymorphicForeignKey;
        return this;
    }
    ...
    public Details__3 withPrecision(Integer precision) {
        this.precision = precision;
        return this;
    }
    ...
    public Details__3 withQueryByDistance(Boolean queryByDistance) {
        this.queryByDistance = queryByDistance;
        return this;
    }
    ...
    public Details__3 withReferenceTargetField(Object referenceTargetField) {
        this.referenceTargetField = referenceTargetField;
        return this;
    }
    ...
    public Details__3 withReferenceTo(List<Object> referenceTo) {
        this.referenceTo = referenceTo;
        return this;
    }
    ...
    public Details__3 withRelationshipName(Object relationshipName) {
        this.relationshipName = relationshipName;
        return this;
    }
    ...
    public Details__3 withRelationshipOrder(Object relationshipOrder) {
        this.relationshipOrder = relationshipOrder;
        return this;
    }
    ...
    public Details__3 withRestrictedDelete(Boolean restrictedDelete) {
        this.restrictedDelete = restrictedDelete;
        return this;
    }
    ...
    public Details__3 withRestrictedPicklist(Boolean restrictedPicklist) {
        this.restrictedPicklist = restrictedPicklist;
        return this;
    }
    ...
    public Details__3 withScale(Integer scale) {
        this.scale = scale;
        return this;
    }
    ...
    public Details__3 withSearchPrefilterable(Boolean searchPrefilterable) {
        this.searchPrefilterable = searchPrefilterable;
        return this;
    }
    ...
    public Details__3 withSoapType(String soapType) {
        this.soapType = soapType;
        return this;
    }
    ...
    public Details__3 withSortable(Boolean sortable) {
        this.sortable = sortable;
        return this;
    }
    ...
    public Details__3 withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Details__3 withUnique(Boolean unique) {
        this.unique = unique;
        return this;
    }
    ...
    public Details__3 withUpdateable(Boolean updateable) {
        this.updateable = updateable;
        return this;
    }
    ...
    public Details__3 withWriteRequiresMasterRead(Boolean writeRequiresMasterRead) {
        this.writeRequiresMasterRead = writeRequiresMasterRead;
        return this;
    }
    ...
    public Details__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Details__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Details__3) == false) {
            return false;
        }
        Details__3 rhs = ((Details__3) other);
