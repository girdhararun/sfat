...
public class PicklistValue__3 {
    ...
    public PicklistValue__3 withActive(Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public PicklistValue__3 withDefaultValue(Boolean defaultValue) {
        this.defaultValue = defaultValue;
        return this;
    }
    ...
    public PicklistValue__3 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public PicklistValue__3 withValidFor(Object validFor) {
        this.validFor = validFor;
        return this;
    }
    ...
    public PicklistValue__3 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public PicklistValue__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PicklistValue__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("active");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PicklistValue__3) == false) {
            return false;
        }
        PicklistValue__3 rhs = ((PicklistValue__3) other);
