...
public class Details__1 {
    ...
    private List<PicklistValue__1> picklistValues = new ArrayList<PicklistValue__1>();
    ...
    public Details__1 withAggregatable(Boolean aggregatable) {
        this.aggregatable = aggregatable;
        return this;
    }
    ...
    public Details__1 withAiPredictionField(Boolean aiPredictionField) {
        this.aiPredictionField = aiPredictionField;
        return this;
    }
    ...
    public Details__1 withAutoNumber(Boolean autoNumber) {
        this.autoNumber = autoNumber;
        return this;
    }
    ...
    public Details__1 withByteLength(Integer byteLength) {
        this.byteLength = byteLength;
        return this;
    }
    ...
    public Details__1 withCalculated(Boolean calculated) {
        this.calculated = calculated;
        return this;
    }
    ...
    public Details__1 withCalculatedFormula(Object calculatedFormula) {
        this.calculatedFormula = calculatedFormula;
        return this;
    }
    ...
    public Details__1 withCascadeDelete(Boolean cascadeDelete) {
        this.cascadeDelete = cascadeDelete;
        return this;
    }
    ...
    public Details__1 withCaseSensitive(Boolean caseSensitive) {
        this.caseSensitive = caseSensitive;
        return this;
    }
    ...
    public Details__1 withCompoundFieldName(String compoundFieldName) {
        this.compoundFieldName = compoundFieldName;
        return this;
    }
    ...
    public Details__1 withControllerName(Object controllerName) {
        this.controllerName = controllerName;
        return this;
    }
    ...
    public Details__1 withCreateable(Boolean createable) {
        this.createable = createable;
        return this;
    }
    ...
    public Details__1 withCustom(Boolean custom) {
        this.custom = custom;
        return this;
    }
    ...
    public Details__1 withDefaultValue(Object defaultValue) {
        this.defaultValue = defaultValue;
        return this;
    }
    ...
    public Details__1 withDefaultValueFormula(Object defaultValueFormula) {
        this.defaultValueFormula = defaultValueFormula;
        return this;
    }
    ...
    public Details__1 withDefaultedOnCreate(Boolean defaultedOnCreate) {
        this.defaultedOnCreate = defaultedOnCreate;
        return this;
    }
    ...
    public Details__1 withDependentPicklist(Boolean dependentPicklist) {
        this.dependentPicklist = dependentPicklist;
        return this;
    }
    ...
    public Details__1 withDeprecatedAndHidden(Boolean deprecatedAndHidden) {
        this.deprecatedAndHidden = deprecatedAndHidden;
        return this;
    }
    ...
    public Details__1 withDigits(Integer digits) {
        this.digits = digits;
        return this;
    }
    ...
    public Details__1 withDisplayLocationInDecimal(Boolean displayLocationInDecimal) {
        this.displayLocationInDecimal = displayLocationInDecimal;
        return this;
    }
    ...
    public Details__1 withEncrypted(Boolean encrypted) {
        this.encrypted = encrypted;
        return this;
    }
    ...
    public Details__1 withExternalId(Boolean externalId) {
        this.externalId = externalId;
        return this;
    }
    ...
    public Details__1 withExtraTypeInfo(Object extraTypeInfo) {
        this.extraTypeInfo = extraTypeInfo;
        return this;
    }
    ...
    public Details__1 withFilterable(Boolean filterable) {
        this.filterable = filterable;
        return this;
    }
    ...
    public Details__1 withFilteredLookupInfo(Object filteredLookupInfo) {
        this.filteredLookupInfo = filteredLookupInfo;
        return this;
    }
    ...
    public Details__1 withFormulaTreatNullNumberAsZero(Boolean formulaTreatNullNumberAsZero) {
        this.formulaTreatNullNumberAsZero = formulaTreatNullNumberAsZero;
        return this;
    }
    ...
    public Details__1 withGroupable(Boolean groupable) {
        this.groupable = groupable;
        return this;
    }
    ...
    public Details__1 withHighScaleNumber(Boolean highScaleNumber) {
        this.highScaleNumber = highScaleNumber;
        return this;
    }
    ...
    public Details__1 withHtmlFormatted(Boolean htmlFormatted) {
        this.htmlFormatted = htmlFormatted;
        return this;
    }
    ...
    public Details__1 withIdLookup(Boolean idLookup) {
        this.idLookup = idLookup;
        return this;
    }
    ...
    public Details__1 withInlineHelpText(Object inlineHelpText) {
        this.inlineHelpText = inlineHelpText;
        return this;
    }
    ...
    public Details__1 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Details__1 withLength(Integer length) {
        this.length = length;
        return this;
    }
    ...
    public Details__1 withMask(Object mask) {
        this.mask = mask;
        return this;
    }
    ...
    public Details__1 withMaskType(Object maskType) {
        this.maskType = maskType;
        return this;
    }
    ...
    public Details__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Details__1 withNameField(Boolean nameField) {
        this.nameField = nameField;
        return this;
    }
    ...
    public Details__1 withNamePointing(Boolean namePointing) {
        this.namePointing = namePointing;
        return this;
    }
    ...
    public Details__1 withNillable(Boolean nillable) {
        this.nillable = nillable;
        return this;
    }
    ...
    public Details__1 withPermissionable(Boolean permissionable) {
        this.permissionable = permissionable;
        return this;
    }

    @JsonProperty("picklistValues")
    public List<PicklistValue__1> getPicklistValues() {
        return picklistValues;
    }

    @JsonProperty("picklistValues")
    public void setPicklistValues(List<PicklistValue__1> picklistValues) {
        this.picklistValues = picklistValues;
    }

    public Details__1 withPicklistValues(List<PicklistValue__1> picklistValues) {
        this.picklistValues = picklistValues;
        return this;
    }
    ...
    public Details__1 withPolymorphicForeignKey(Boolean polymorphicForeignKey) {
        this.polymorphicForeignKey = polymorphicForeignKey;
        return this;
    }
    ...
    public Details__1 withPrecision(Integer precision) {
        this.precision = precision;
        return this;
    }
    ...
    public Details__1 withQueryByDistance(Boolean queryByDistance) {
        this.queryByDistance = queryByDistance;
        return this;
    }
    ...
    public Details__1 withReferenceTargetField(Object referenceTargetField) {
        this.referenceTargetField = referenceTargetField;
        return this;
    }
    ...
    public Details__1 withReferenceTo(List<Object> referenceTo) {
        this.referenceTo = referenceTo;
        return this;
    }
    ...
    public Details__1 withRelationshipName(Object relationshipName) {
        this.relationshipName = relationshipName;
        return this;
    }
    ...
    public Details__1 withRelationshipOrder(Object relationshipOrder) {
        this.relationshipOrder = relationshipOrder;
        return this;
    }
    ...
    public Details__1 withRestrictedDelete(Boolean restrictedDelete) {
        this.restrictedDelete = restrictedDelete;
        return this;
    }
    ...
    public Details__1 withRestrictedPicklist(Boolean restrictedPicklist) {
        this.restrictedPicklist = restrictedPicklist;
        return this;
    }
    ...
    public Details__1 withScale(Integer scale) {
        this.scale = scale;
        return this;
    }
    ...
    public Details__1 withSearchPrefilterable(Boolean searchPrefilterable) {
        this.searchPrefilterable = searchPrefilterable;
        return this;
    }
    ...
    public Details__1 withSoapType(String soapType) {
        this.soapType = soapType;
        return this;
    }
    ...
    public Details__1 withSortable(Boolean sortable) {
        this.sortable = sortable;
        return this;
    }
    ...
    public Details__1 withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public Details__1 withUnique(Boolean unique) {
        this.unique = unique;
        return this;
    }
    ...
    public Details__1 withUpdateable(Boolean updateable) {
        this.updateable = updateable;
        return this;
    }
    ...
    public Details__1 withWriteRequiresMasterRead(Boolean writeRequiresMasterRead) {
        this.writeRequiresMasterRead = writeRequiresMasterRead;
        return this;
    }
    ...
    public Details__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Details__1) == false) {
            return false;
        }
        Details__1 rhs = ((Details__1) other);
