...
public class LayoutItem {
    ...
    public LayoutItem withEditableForNew(Boolean editableForNew) {
        this.editableForNew = editableForNew;
        return this;
    }
    ...
    public LayoutItem withEditableForUpdate(Boolean editableForUpdate) {
        this.editableForUpdate = editableForUpdate;
        return this;
    }
    ...
    public LayoutItem withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LayoutItem withLayoutComponents(List<LayoutComponent> layoutComponents) {
        this.layoutComponents = layoutComponents;
        return this;
    }
    ...
    public LayoutItem withPlaceholder(Boolean placeholder) {
        this.placeholder = placeholder;
        return this;
    }
    ...
    public LayoutItem withRequired(Boolean required) {
        this.required = required;
        return this;
    }
    ...
    public LayoutItem withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LayoutItem.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LayoutItem) == false) {
            return false;
        }
        LayoutItem rhs = ((LayoutItem) other);
